---
title: 【SATORI v0.28.1】190スキル×50パイプライン逆引き辞書 完全索引
tags:
  - バイオインフォマティクス
  - 機械学習
  - パイプライン
...
**[SATORI](https://github.com/nahisaho/satori)** は **GitHub Copilot** 上で動作する、190 の専門スキルと 50 の統合パイプライン（26 ドメイン + 15 クロスドメイン + 5 インダストリー + 4 メソドロジー）により、仮説構築から論文出版まで、あらゆる科学研究ワークフローを自動化するフレームワークです。
